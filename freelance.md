...
- Desktop applications {% include badge.html items="windows:brands:Windows,linux:brands:Linux" %}
- Websites and web tools {% include badge.html items="react:brands:ReactJS,js:brands:Javascript,sass:brands:SCSS,css3:brands:CSS,html5:brands:HTML" %}
- Discord bots {% include badge.html items="windows:brands:C#,python:brands:Python" %}
- Automation scripts {% include badge.html items="terminal:solid:Linux Shell,terminal:solid:Powershell,python:brands:Python" %}
- Mobile applications {% include badge.html items="react:brands:React Native" %}
- Game mods {% include badge.html items="code:solid:Lua,python:brands:Python,unity:brands:C#" %}
- School programming assignments / tutoring 
  (I can provide guidance, debugging help, or optimization advice, but I expect you to make a first attempt and show your work. I won’t do your class assignments from scratch; I have my own code of ethics.)
